      ...
      <div className="flex items-center justify-between mx-auto ">
        ...
        <nav className="flex  items-center justify-between gap-5 text-base md:ml-auto">
          ...
          {username ? (
            ...
            <div className="items-center h-full pl-6 px-8 ml-6 border-l border-gray-200 ">
              <Link href="/login" className="px-4 mx-6 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-gray-800 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease">Login</Link>
              <Link
                href="/signup"
